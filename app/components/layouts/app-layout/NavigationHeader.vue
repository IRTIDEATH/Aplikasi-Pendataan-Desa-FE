...
<template>
	<header>
		<div class="container px-4 py-5 md:px-8">
			<div class="flex items-center justify-between">
				<NuxtLink
					to="/"
					class="flex gap-2 items-center text-nord6"
				>
					<svg
						width="30"
						height="30"
					...
					>
						...
						<path
							...
							stroke-linejoin="round"
						/>
					</svg> <span class="text-lg font-semibold">IPeda</span>
				</NuxtLink>
				...
				<div class="flex items-center">
					<Button
						...
						size="wrapper"
					>
						<span class="block rounded-md bg-primary-layer px-4 py-1.5">Login</span>
					</Button>
				</div>
			</div>
		</div>
